...
(
    ...
    book_id  int references Book (id)                  NOT NULL,
    rating   int CHECK ( rating >= 0 && rating =< 100) NOT NULL,
...
INSERT INTO Publisher (name, address, phone) VALUES ('АСТ', 'eeeeee', '+12345678');
INSERT INTO Publisher (name, address, phone) VALUES ('Вече', 'ttttttttt', '+12345678');

-- ЗАПОЛНЕНИЕ ТАБЛИЦЫ BookIssue ТЕСТОВЫМИ ЗНАЧЕНИЯМИ
INSERT INTO BookIssue (book_id, publisher_id, year, quantity, price) VALUES (1, 1, 2020, 5000, 400);
INSERT INTO BookIssue (book_id, publisher_id, year, quantity, price) VALUES (1, 2, 2016, 5000, 400);
INSERT INTO BookIssue (book_id, publisher_id, year, quantity, price) VALUES (2, 1, 2022, 5000, 400);
INSERT INTO BookIssue (book_id, publisher_id, year, quantity, price) VALUES (2, 3, 2023, 5000, 400);
INSERT INTO BookIssue (book_id, publisher_id, year, quantity, price) VALUES (6, 2, 2003, 5000, 400);